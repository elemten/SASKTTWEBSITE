...
function getDefaultTimeSlots(date) {
  ...
  if (dayOfWeek === 1) {
    slots.push({
      time: '11:00',
      display: '11:00 AM - 12:00 PM (1 hour)',
      available: true
    });
  } else if (dayOfWeek >= 2 && dayOfWeek <= 4) {
    slots.push({
      time: '11:00',
      display: '11:00 AM - 12:30 PM (1.5 hours)',
      available: true
    });
    slots.push({
      time: '12:30',
      display: '12:30 PM - 2:00 PM (1.5 hours)',
      available: true
    });
    slots.push({
      time: '11:00-2.75',
      display: '11:00 AM - 1:45 PM (2.75 hours)',
      available: true
    });
  } else if (dayOfWeek === 5) {
    slots.push({
    ...
    slots.push({
      time: '14:00',
      display: '2:00 PM - 3:30 PM (1.5 hours)',
      available: true
    });
    slots.push({
      time: '15:30',
      display: '3:30 PM - 5:00 PM (1.5 hours)',
      available: true
    });
    slots.push({
      time: '11:00-5',
      display: '11:00 AM - 4:00 PM (5 hours)',
      available: true
    });
  }
  return slots;
