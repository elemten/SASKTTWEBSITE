  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed inset-0 z-[1000] bg-black/40 transition-opacity md:hidden h-[100vh] w-[100vw] ${open ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none mobile-overlay-hidden"
          }`}
      ...
      <div
        ...
        className={`fixed right-0 top-0 z-[1001] h-[100vh] w-[86vw] max-w-[380px] bg-white shadow-xl outline-none transition-transform md:hidden mobile-menu-container overflow-hidden flex flex-col ${open ? "translate-x-0" : "translate-x-full mobile-menu-hidden"
          }`}
